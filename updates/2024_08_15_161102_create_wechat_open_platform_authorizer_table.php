    ...
    public function up()
    {
        if (!Schema::hasTable('wechat_open_platform_authorizer')) {
            Schema::create('wechat_open_platform_authorizer', function (Blueprint $table) {
                ...
                $table->tinyInteger('verify_type')->default('0')->comment('0 - 未认证；1 - 已认证；2 - 新浪微博认证；3 - 未通过名称认证；4 - 未通过名称认证，但通过了新浪微博认证；');
                ...
                $table->tinyInteger('account_status')->default('0')->comment('1-正常；14-已注销；16-已封禁；18-已告警；19-已冻结；');
